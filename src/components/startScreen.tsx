...
function StartScreen() {
  ...
  const [wasSkipped, setWasSkipped] = useState(
    getItem("wasSkipped") === "true" ? true : false
  );
  ...
  return (
    <div className="maxWidth">
      <div className="startScreen noselect">
        <Button
          iconLeading={stateSoundOn ? soundOn : soundOff}
          btn={"btn"}
          size={"medium"}
          type={"Primary"}
          drop={"dropSmall"}
        ...
        />
        <img
          style={{ marginBottom: "10%", height: "30vh", marginTop: "10vh" }}
          src={Image}
          alt=""
        />
        <Button
        ...
        >
          <p
            style={{ margin: "16px", fontWeight: "400", cursor: "pointer" }}
            onClick={() => {
              navigate("/about");
            }}
          >
