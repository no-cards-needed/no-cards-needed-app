...
function toggleSound() {
	...
	<div className="maxWidth">
		<div className="startScreen noselect">
			<Button iconLeading={stateSoundOn ? soundOn : soundOff} btn={"btn"} size={"medium"} type={"Primary"} drop={"dropSmall"} style={{position: "relative", top: "12.5px", left: "12.5px", width: "48px"}} click={toggleSound} />
