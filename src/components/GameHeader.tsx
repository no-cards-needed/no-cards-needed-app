	...
	<div className="gameHeader criticalMaxWidth" id="basicDrop">
		...
		<div className="modal" id="basicDrop">
			...
			<div className="buttonContainer">
				<Button label={"No"} btn={"btn"} size={"medium"} type={"Secondary"} drop={"dropSmall"} style={{width: "100%"}} click={toggleModal} />
				<Button label={"Yes"} btn={"btn"} size={"medium"} type={"Primary"} drop={"dropSmall"} style={{width: "100%"}} click={() => {navigate('/')}}/>
			</div>
		</div>
		</div>
